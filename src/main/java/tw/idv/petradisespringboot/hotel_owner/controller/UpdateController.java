...
//			個人測試
	...
	public ResponseEntity<String> deleteHotelOwner(@PathVariable("hotelId") Integer hotelId){
		  hotelOwnerService.deleteOwner(hotelId);
		return ResponseEntity.ok("會員資料已刪除");
	}
}
